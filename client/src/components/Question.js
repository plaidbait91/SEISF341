...
const Question = () => {
    ...
    return ( 
        <Grid
            ...
            <Box>Asked, {date.getHours()}:{date.getMinutes()} on {date.toLocaleString('default', { month: 'long' })} {date.getDate()}, {date.getFullYear()} by {question.postedBy.fullName} ({question.postedBy.username})</Box>
            </GridItem>
